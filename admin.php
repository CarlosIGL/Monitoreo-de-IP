...
<main role="main">
    ...
    <div class="container">
        ...
        <div class="container-add">
            <h2 class="container__title">Generar IPs</h2>
            <form action="Agregar.php" method="post" class="container__form" enctype="multipart/form-data">
                <label for="" class="container__label">IP </label>
                <input type="text" class="container__input" name="ip" required>
                <label for="" class="container__label">Descripción </label>
                <input type="text" class="container__input" name="descripción" required>
                <input  type="submit" class="container__submit" value="Agregar IP">
        ...
        <div class="container-table container-table--edit">
            ...
            while ($row = $result->fetch_assoc()){
                $fila = array($row['NUMBER'],$row['IP'],$row['DESCRIPTION']);
            ...
            <?php  foreach ($results as $item =>$k): ?>
                ...
                <div class="table__item"><?php
                    if ($results[$item] ==0){
                        ...
                        echo '<img src="img/icono_gris.png.crdownload" width="30" height="30">';
                    }
                    ?></div>
                <div class="table__item"><?php echo $datos[$item][2]; ?></div>
                <div class="table__item">
                    <a href="Eliminar.php?id=<?php echo $datos[$item][0]; ?>" >Eliminar</a>
                </div>
            <?php endforeach;?>
